...
(function ($) {
    ...
    $.fn.initDataTables = function (config, options) {
        ...
        $.fn.initDataTables.defaults.url =
                            ...
                            ajax: function (request, drawCallback, settings) {
                                if (data) {
                                    ...
                                    if (Object.keys(state).length) {
                                        ...
                                        api.order(
                                            Array.isArray(merged.order) &&
                                                merged.order.length > 0
                                                ? merged.order
                                                : api.state().order
                                        )
                            ...
                            if (!baseState) {
                                ...
                                switch (config.state) {
                                    case "fragment":
                                        ...
                                        break;
                                    case "query":
                                        var windowLocationSearch = deparam(
